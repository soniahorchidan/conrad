...
class ModelFactory:
    ...
    def load_model(self):
        ...
        if self.model_to_infer.lower() == "threehoppipeline":
            ...
            self.inf_args.model_to_infer = "ThreeHopPipeline"
        ...
        elif self.model_to_infer.lower() == "twounionpipeline":
            inf_args_ultra = self.inf_args
            inf_args_ultra.model_to_infer = "ULTRA"
            model_factory_ultra = ModelFactory(inf_args_ultra)
            model_factory_ultra.prepare_model()
            ...
            self.inf_args.model_to_infer = "TwoUnionPipeline"
            model: ModelUtils = getattr(models, self.inf_args.model_to_infer)(
                model_factory_ultra.model, model_factory_dbexec.model, self.inf_args, self.inf_args.device
            )
        
        elif self.model_to_infer.lower() == "twointersectprojectpipeline":
            inf_args_ultra = self.inf_args
            inf_args_ultra.model_to_infer = "ULTRA"
            model_factory_ultra = ModelFactory(inf_args_ultra)
            model_factory_ultra.prepare_model()
            ...
            self.inf_args.model_to_infer = "TwoIntersectProjectPipeline"
            model: ModelUtils = getattr(models, self.inf_args.model_to_infer)(
                model_factory_ultra.model, model_factory_dbexec.model, self.inf_args, self.inf_args.device
            )
