...
class VectorConformalRiskControl:
    ...
    def prepare_data(self, save_path: str, db_controller: Any, 
                    vectordb_controller: Any, calibration_data_path: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            vectordb_controller: Vector database controller
        ...
        if calibration_data_path is not None:
            ...
            full_calib_data = self.generateCalibrateSamples_fn(
                save_path, db_controller, vectordb_controller, 
            ...
            full_calib_data = self.generateCalibrateSamples_fn(
                save_path, db_controller, vectordb_controller, None, None, return_queries=True
            )
    ...
    def train(self, save_path: str, db_controller: Any, vectordb_controller: Any) -> None:
        """
    ...
    def prepare_calibrate(self, save_path: str, db_controller: Any, 
                         vectordb_controller: Any, threshold: float = -1, 
        ...
        self.prepare_data(save_path, db_controller, vectordb_controller, calibration_data_path)
