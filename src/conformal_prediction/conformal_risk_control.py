...
class ConformalRiskControl(object):
    ...
    def train(self, save_path, db_controller):
    ...
    def calibrate(self, db_controller, threshold=-1):
    ...
    def prepare_calibrate(
        self, save_path, db_controller, threshold=-1
    ):
        self.prepare_data(save_path, db_controller)
        self.train(save_path, db_controller)
        self.metadata = self.calibrate(db_controller, threshold)
