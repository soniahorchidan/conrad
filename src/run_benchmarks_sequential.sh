...
python -u run_crc_benchmark_auto.py --confidence-levels 0.5 0.6 0.7 0.8 0.9 --max-eval-queries 1000 --model_to_infer ThreeHopPipeline --calib_batch_size 8 --dataset fb15k-237 --use-ultraquery
...
# python -u run_crc_benchmark_auto.py --confidence-levels 0.5 0.6 0.7 0.8 0.9 --max-eval-queries 1000 --model_to_infer TwoUnionPipeline --calib_batch_size 2 --dataset nell-955
...
# python -u run_crc_benchmark_auto.py --confidence-levels 0.5 0.6 0.7 0.8 0.9 --max-eval-queries 1000 --model_to_infer TwoIntersectProjectPipeline --calib_batch_size 4 --dataset nell-955
